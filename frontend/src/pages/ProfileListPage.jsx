...
const ProfileListPage = ({ showFooter = true }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <div className={`container mx-auto ${!isHomePage && 'p-4'} flex-grow`}>
                {!isHomePage && (
                    <>
                    ...
                    {profiles.map((profile) => (
                        <div key={profile.profileId} className="bg-white rounded-lg shadow-md p-6">
                                ...
                                <div className="mb-4">
                                    <div className="flex flex-wrap gap-2">
                                        {profile.skills.map((skill, index) => (
                                            <span 
                                                key={index}
                                                className="bg-blue-100 text-blue-800 text-sm px-2 py-1 rounded font-medium"
                                            >
                                                {skill.name}
                                            </span>
                                        ))}
                            ...
                            <Link 
                                ...
                                className="mt-4 block text-center bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 font-medium"
                            >
                                자세히 보기
                            </Link>
                        </div>
